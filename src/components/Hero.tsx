 ...
 *
 * Reduced motion is handled by `initial={false}` on the container, which
 * propagates to every child: they mount straight into their `show` state.
 */
    ...
    <section id="top" className="grid-bg relative px-8 pb-24 pt-[88px]">
      ...
      >
        ...
        <div>
          ...
          <motion.div variants={rise} className="mt-[34px] flex flex-wrap gap-3.5">
            <a
